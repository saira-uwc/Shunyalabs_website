...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    - generic [ref=e3]:
        ...
        - generic [ref=e5]:
          ...
          - generic [ref=e28]:
            ...
            - link "Contact Sales" [ref=e31] [cursor=pointer]:
              - /url: /contact
      - generic [ref=e33]:
        - heading "Intelligence That Listens. APIs That Power Contact Centers" [level=1] [ref=e34]
        - paragraph [ref=e35]: Real-time transcription, analytics, and voice automation — plug-and-play intelligence for every conversation.
      ...
      - generic [ref=e40]:
        - generic [ref=e42]:
          - heading "End-to-end support infra—secure, compliant, structured" [level=2] [ref=e44]
          - generic [ref=e45]:
            - generic [ref=e46]:
              - generic [ref=e48]:
                - generic [ref=e49] [cursor=pointer]:
                  - heading "Get structured data" [level=3] [ref=e50]
                  - paragraph [ref=e51]: Convert messages & attachments to structured fields with smart OCR + LLM reasoning. Pull out intent, product, issue type, account data, and promised actions—export as CRM/ITSM-ready JSON.
                - generic [ref=e52] [cursor=pointer]:
                  - heading "QA & compliance" [level=3] [ref=e53]
                  - paragraph [ref=e54]: Auto-check script adherence and policies, redact card details and personal data, and keep full trails with audit-friendly logs.
                - generic [ref=e55] [cursor=pointer]:
                  - heading "Secure by design" [level=3] [ref=e56]
                  - paragraph [ref=e57]: Deploy in your private cloud or on-premises. CPU-efficient, cost-controlled, and built for strict privacy and uptime.
              - button "Try Now" [ref=e58] [cursor=pointer]
            - img "End-to-end support infra—secure, compliant, structured" [ref=e61]
        - generic [ref=e63]:
          - heading "Equip agents to win and lift your CSAT" [level=2] [ref=e65]
          - generic [ref=e66]:
            - generic [ref=e67]:
              - generic [ref=e69]:
                - generic [ref=e70] [cursor=pointer]:
                  - heading "Cue agents in real-time" [level=3] [ref=e71]
                  - paragraph [ref=e72]: Live captions, knowledge-base lookups, and “next best response” with steady sub-second speed. Embed in any agent desktop or cloud contact-center platform.
                - generic [ref=e73] [cursor=pointer]:
                  - heading "Automate procedures" [level=3] [ref=e74]
                  - paragraph [ref=e75]: Detect intent and complete common requests end-to-end. Smart routing sends complex cases to the right expert—no dropped balls.
                - generic [ref=e76] [cursor=pointer]:
                  - heading "Understand every customer" [level=3] [ref=e77]
                  - paragraph [ref=e78]: Transcripts in 120+ languages—accent-aware, and code-switching smart—built for real-world noise.
              - button "Try Now" [ref=e79] [cursor=pointer]
            - img "Equip agents to win and lift your CSAT" [ref=e82]
        - generic [ref=e84]:
          - heading "Get post-call intelligence to see the bigger picture" [level=2] [ref=e86]
          - generic [ref=e87]:
            - generic [ref=e88]:
              - generic [ref=e90]:
                - generic [ref=e91] [cursor=pointer]:
                  - heading "Analytics" [level=3] [ref=e92]
                  - paragraph [ref=e93]: Auto-generate call summaries, sentiment, topics, and trends with searchable transcripts—export to QA tools and your data lake.
                - generic [ref=e94] [cursor=pointer]:
                  - heading "Insights-driven coaching" [level=3] [ref=e95]
                  - paragraph [ref=e96]: Get sentiment analysis and trends from every transcript and turn knowledge from every conversation into agent coaching that lifts performance in real time.
                - generic [ref=e97] [cursor=pointer]:
                  - heading "Be future ready with features" [level=3] [ref=e98]
                  - paragraph [ref=e99]: Partner with an R&D leader—continuous model upgrades and new features without re-platforming.
              - button "Try Now" [ref=e100] [cursor=pointer]
            - img "Get post-call intelligence to see the bigger picture" [ref=e103]
    - contentinfo [ref=e104]:
      - generic [ref=e105]:
        - paragraph [ref=e106]: Get Started
        - paragraph [ref=e107]: Make your call center smart and future ready today.
        - generic [ref=e108]:
