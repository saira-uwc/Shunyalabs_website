...
- Name: modules/homepage/homepage/widget.spec.js >> Homepage - widget (Figma exact) >> Widget content and actions
- Location: tests/modules/homepage/homepage/widget.spec.js:6:3
