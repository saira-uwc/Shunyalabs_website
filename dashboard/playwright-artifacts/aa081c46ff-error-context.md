...
- Location: tests/modules/solutions/healthcare/design.spec.js:13:3

# Error details

```
Error: [content] Page title: expected "AI Medical Transcription & Speech Recognition for Healthcare | Shunya Labs" but got "AI Medical Transcription & Healthcare Speech AI | Shunya Labs"
...
```ts
  ...
  6  |   (page) => page.moduleKey === 'solutions' && page.slug === 'healthcare'
  7  | );
  8  | 
  9  | const moduleLabel = pageEntry?.moduleLabel || 'solutions';
  10 | const pageLabel = pageEntry?.pageLabel || 'healthcare';
  11 | 
