...
- Location: tests/modules/solutions/contact-centers/design.spec.js:13:3

# Error details

```
Error: [content] Page title: expected "AI Speech Analytics & Voice Intelligence for Contact Centers | Shunya Labs" but got "AI Speech Analytics for Contact Centers | Shunya Labs"
...
```ts
  ...
  6  |   (page) => page.moduleKey === 'solutions' && page.slug === 'contact-centers'
  7  | );
  8  | 
  9  | const moduleLabel = pageEntry?.moduleLabel || 'solutions';
  10 | const pageLabel = pageEntry?.pageLabel || 'contact-centers';
  11 | 
