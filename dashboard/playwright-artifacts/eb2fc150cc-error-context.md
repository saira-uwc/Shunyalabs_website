...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    - generic [ref=e3]:
      ...
      - link "Blog Banner 12 Mar 2026 Why Sub-100ms Voice AI Latency Is the New Table Stakes Voice AI latency below 500ms is no longer a differentiator. It is the baseline expectation. Here is where the time goes, why pipelines break, and how to fix each layer. AI Trends Navvya Jain" [ref=e13] [cursor=pointer]:
        - /url: /blog/sub-100ms-voice-ai-latency-Is-the-new-table-stakes
        - img "Blog Banner" [ref=e15]
        - generic [ref=e17]: 12 Mar 2026
        - heading "Why Sub-100ms Voice AI Latency Is the New Table Stakes" [level=2] [ref=e18]
        - paragraph [ref=e19]: Voice AI latency below 500ms is no longer a differentiator. It is the baseline expectation. Here is where the time goes, why pipelines break, and how to fix each layer.
        - generic [ref=e21]: AI Trends
        - paragraph [ref=e22]: Navvya Jain
      - generic [ref=e25]:
        - generic [ref=e26]:
        ...
        - main [ref=e50]:
          - 'link "Voice AI''s trillion-dollar opportunity: Conversation graphs AI Trends Voice AI''s trillion-dollar opportunity: Conversation graphs 11 Mar 2026" [ref=e51] [cursor=pointer]':
            - /url: /blog/voice-al-trillion-dollar-opportunity
            - 'img "Voice AI''s trillion-dollar opportunity: Conversation graphs" [ref=e53]'
            - generic [ref=e54]:
              - text: AI Trends
              - 'heading "Voice AI''s trillion-dollar opportunity: Conversation graphs" [level=3] [ref=e55]'
              - paragraph [ref=e56]: 11 Mar 2026
          - link "Why Indic Language Voice AI Is the Biggest Untapped Opportunity in Tech AI Trends Why Indic Language Voice AI Is the Biggest Untapped Opportunity in Tech 10 Mar 2026" [ref=e57] [cursor=pointer]:
            - /url: /blog/indic-language-voice-ai-biggest-untapped-opportunity
            - img "Why Indic Language Voice AI Is the Biggest Untapped Opportunity in Tech" [ref=e59]
            - generic [ref=e60]:
              - text: AI Trends
              - heading "Why Indic Language Voice AI Is the Biggest Untapped Opportunity in Tech" [level=3] [ref=e61]
              - paragraph [ref=e62]: 10 Mar 2026
          - 'link "Zero STT Med: Accurate, Real-Time Medical Speech-to-Text for Healthcare Professionals Product Zero STT Med: Accurate, Real-Time Medical Speech-to-Text for Healthcare Professionals 18 Nov 2025" [ref=e63] [cursor=pointer]':
            - /url: /blog/introducing-zero-stt-med-medical-speech-to-text-for-healthcare
            - 'img "Zero STT Med: Accurate, Real-Time Medical Speech-to-Text for Healthcare Professionals" [ref=e65]'
            - generic [ref=e66]:
              - text: Product
              - 'heading "Zero STT Med: Accurate, Real-Time Medical Speech-to-Text for Healthcare Professionals" [level=3] [ref=e67]'
              - paragraph [ref=e68]: 18 Nov 2025
          - link "Why Multilingual Voice AI Fails on Real-World Audio — and How We Fixed It Product Why Multilingual Voice AI Fails on Real-World Audio — and How We Fixed It 03 Nov 2025" [ref=e69] [cursor=pointer]:
            - /url: /blog/why-multilingual-voice-ai-fails-on-real-world-audio-and-how-we-fixed-it
            - img "Why Multilingual Voice AI Fails on Real-World Audio — and How We Fixed It" [ref=e71]
            - generic [ref=e72]:
              - text: Product
              - heading "Why Multilingual Voice AI Fails on Real-World Audio — and How We Fixed It" [level=3] [ref=e73]
              - paragraph [ref=e74]: 03 Nov 2025
          - 'link "Getting Started with ASR APIs: Python Quickstart Build & Learn Getting Started with ASR APIs: Python Quickstart 23 Oct 2025" [ref=e75] [cursor=pointer]':
            - /url: /blog/getting-started-with-asr-apis-python-quickstart
            - 'img "Getting Started with ASR APIs: Python Quickstart" [ref=e77]'
            - generic [ref=e78]:
              - text: Build & Learn
              - 'heading "Getting Started with ASR APIs: Python Quickstart" [level=3] [ref=e79]'
              - paragraph [ref=e80]: 23 Oct 2025
          - 'link "Getting Started with ASR APIs: Node.js Quickstart Build & Learn Getting Started with ASR APIs: Node.js Quickstart 23 Oct 2025" [ref=e81] [cursor=pointer]':
            - /url: /blog/getting-started-with-asr-apis-node-js-quickstart
            - 'img "Getting Started with ASR APIs: Node.js Quickstart" [ref=e83]'
            - generic [ref=e84]:
              - text: Build & Learn
              - 'heading "Getting Started with ASR APIs: Node.js Quickstart" [level=3] [ref=e85]'
              - paragraph [ref=e86]: 23 Oct 2025
        - generic [ref=e87]:
