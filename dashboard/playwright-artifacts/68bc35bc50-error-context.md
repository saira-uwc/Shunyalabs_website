...
```
Error: [layout] Section "Voice AI on your terms" not found on page
...
```
Error: [layout] Section "Custom BuiltFor Your Enterprise" not found on page
...
```
Error: [layout] Section "Small, sharp,specialised" not found on page
...
```
Error: [layout] Section "Tell Us Your Domain.We'll Build the Model." not found on page
...
```
Error: [layout] Section "What Sets Us Apart" not found on page
...
```
Error: [layout] Section "Start Building with Shunya Labs." not found on page
...
```
Error: [layout] Section "Language Regions" not found on page
...
```
Error: [layout] Section "Section 17" not found on page
...
```
Error: [layout] Section "Section 18" not found on page
...
```
Error: [layout] Section "Section 19" not found on page
...
```
Error: [content] Page title: expected "Voice AI Platform for developers & enterprises | Shunya Labs" but got "Enterprise Voice AI Platform | STT, TTS & Voice Agents | Shunya Labs"
...
```
Error: [console] 2 console error(s): Error: <path> attribute d: Expected number, "… 15.3 0 0 1 4-10z". | Error: <path> attribute d: Expected number, "… 15.3 0 0 1 4-10z".
...
```
Error: 29 design compliance issue(s) found
