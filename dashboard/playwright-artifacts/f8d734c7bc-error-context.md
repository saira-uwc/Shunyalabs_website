...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    - generic [ref=e3]:
      ...
      - 'link "Blog Banner 18 Nov 2025 Introducing Zero STT Med: Shunya Labs’ Purpose-Built Medical Speech-to-Text Transcription for Healthcare Actual hospitals are inundated with alarms, cross-talk, muffled conversations through surgical masks and contextual shorthands that can generally be understood only by highly specialized participants. Product Abeer Sehrawat" [ref=e38] [cursor=pointer]':
        - /url: /blog/introducing-zero-stt-med-medical-speech-to-text-for-healthcare
        - img "Blog Banner" [ref=e40]
        - generic [ref=e42]: 18 Nov 2025
        - 'heading "Introducing Zero STT Med: Shunya Labs’ Purpose-Built Medical Speech-to-Text Transcription for Healthcare" [level=2] [ref=e43]'
        - paragraph [ref=e44]: Actual hospitals are inundated with alarms, cross-talk, muffled conversations through surgical masks and contextual shorthands that can generally be understood only by highly specialized participants.
        - generic [ref=e46]: Product
        - paragraph [ref=e47]: Abeer Sehrawat
      - generic [ref=e50]:
        - generic [ref=e51]:
        ...
        - main [ref=e75]:
          - link "Why Multilingual Voice AI Fails on Real-World Audio — and How We Fixed It Product Why Multilingual Voice AI Fails on Real-World Audio — and How We Fixed It 03 Nov 2025" [ref=e76] [cursor=pointer]:
            - /url: /blog/why-multilingual-voice-ai-fails-on-real-world-audio-and-how-we-fixed-it
            - img "Why Multilingual Voice AI Fails on Real-World Audio — and How We Fixed It" [ref=e78]
            - generic [ref=e79]:
              - text: Product
              - heading "Why Multilingual Voice AI Fails on Real-World Audio — and How We Fixed It" [level=3] [ref=e80]
              - paragraph [ref=e81]: 03 Nov 2025
          - 'link "Getting Started with ASR APIs: Python Quickstart Build & Learn Getting Started with ASR APIs: Python Quickstart 23 Oct 2025" [ref=e82] [cursor=pointer]':
            - /url: /blog/getting-started-with-asr-apis-python-quickstart
            - 'img "Getting Started with ASR APIs: Python Quickstart" [ref=e84]'
            - generic [ref=e85]:
              - text: Build & Learn
              - 'heading "Getting Started with ASR APIs: Python Quickstart" [level=3] [ref=e86]'
              - paragraph [ref=e87]: 23 Oct 2025
          - 'link "Getting Started with ASR APIs: Node.js Quickstart Build & Learn Getting Started with ASR APIs: Node.js Quickstart 23 Oct 2025" [ref=e88] [cursor=pointer]':
            - /url: /blog/getting-started-with-asr-apis-node-js-quickstart
            - 'img "Getting Started with ASR APIs: Node.js Quickstart" [ref=e90]'
            - generic [ref=e91]:
              - text: Build & Learn
              - 'heading "Getting Started with ASR APIs: Node.js Quickstart" [level=3] [ref=e92]'
              - paragraph [ref=e93]: 23 Oct 2025
          - link "Benchmarking Top Open-Source Speech Recognition Models AI Trends Benchmarking Top Open-Source Speech Recognition Models 10 Oct 2025" [ref=e94] [cursor=pointer]:
            - /url: /blog/benchmarking-top-open-source-speech-recognition-models
            - img "Benchmarking Top Open-Source Speech Recognition Models" [ref=e96]
            - generic [ref=e97]:
              - text: AI Trends
              - heading "Benchmarking Top Open-Source Speech Recognition Models" [level=3] [ref=e98]
              - paragraph [ref=e99]: 10 Oct 2025
          - 'link "Top 10 AI Transcription Tools: A Simple Comparison AI Trends Top 10 AI Transcription Tools: A Simple Comparison 10 Oct 2025" [ref=e100] [cursor=pointer]':
            - /url: /blog/top-10-ai-transcription-tools-a-simple-comparison
            - 'img "Top 10 AI Transcription Tools: A Simple Comparison" [ref=e102]'
            - generic [ref=e103]:
              - text: AI Trends
              - 'heading "Top 10 AI Transcription Tools: A Simple Comparison" [level=3] [ref=e104]'
              - paragraph [ref=e105]: 10 Oct 2025
          - 'link "Speech-to-Text AI in Action: Top 10 Use Cases Across Industries Use cases Speech-to-Text AI in Action: Top 10 Use Cases Across Industries 10 Oct 2025" [ref=e106] [cursor=pointer]':
            - /url: /blog/speech-to-text-ai-in-action-top-10-use-cases-across-industries
            - 'img "Speech-to-Text AI in Action: Top 10 Use Cases Across Industries" [ref=e108]'
            - generic [ref=e109]:
              - text: Use cases
              - 'heading "Speech-to-Text AI in Action: Top 10 Use Cases Across Industries" [level=3] [ref=e110]'
              - paragraph [ref=e111]: 10 Oct 2025
        - generic [ref=e112]:
